      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            width="27"
            src="https://yt3.ggpht.com/yti/AHXOFjW2J2p9OTjPFI7si9EjZZauiZcAZetrucEkPXmCsg=s88-c-k-c0x00ffffff-no-rj-mo"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Miloslavskiy Sergey</div>
          <ChevronDown
            v-if="!openMenu"
            @click="openMenu = true"
            fillColor="#FFFFFF"
